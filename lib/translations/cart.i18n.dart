...
extension Localization on String {
  ...
  static var _t = Translations("en") +
      ...
      {
        "en": "You have %s in your cart",
        "fr": "Vous avez %s dans votre panier",
        "es": "Tienes %s en tu carrito",
        "de": "Sie haben %s in Ihrem Warenkorb",
        "pt": "Você tem %s no seu carrinho",
        "ar": "لديك %s في سلة التسوق الخاصة بك",
        "ko": "장바구니에 %s 이(가) 있습니다."
      };
